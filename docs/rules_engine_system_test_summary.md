...
| ST-007 | Spark output contract | Compact and full-audit success, no-match, and error rows have identical business results and exact ordered columns; full audit identifies engine and audit-schema versions. |
