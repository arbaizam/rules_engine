...
from rules_engine.dataframe_evaluation import top_level_column
...
class RulesetCoverageAnalyzer:
    ...
    def analyze(
        ...
        *,
        ...
        matched_col = top_level_column(f"{column_prefix}_matched")
        matched_ids_col = top_level_column(f"{column_prefix}_matched_rule_ids")
        error_col = top_level_column(f"{column_prefix}_error")
